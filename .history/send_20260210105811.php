...
if (isset($_POST["done"])) {
    ...
    // 3. Prepared Statement (Protection against SQL Injection)
            ...
            <div class="min-h-screen flex items-center justify-center p-4">
                <div class="bg-slate-900 border border-slate-800 rounded-lg shadow-2xl max-w-2xl w-full overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-orange-600 to-orange-500 p-8 text-center">
                        ...
                        <p class="text-orange-100 text-sm font-bold uppercase tracking-widest mt-2">Thank you for your purchase</p>
                    </div>
                    ...
                    <div class="p-8">
                        <div class="mb-6 p-4 bg-slate-800 border-l-4 border-orange-600 rounded">
                            ...
                            <p class="text-2xl font-black text-white">#<?php echo str_pad($order_id, 6, '0', STR_PAD_LEFT); ?></p>
                        </div>
                        ...
                        <div class="space-y-4 mb-8">
                            ...
                            <div class="bg-slate-800 p-6 rounded-lg">
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    <span class="bg-orange-600/10 text-orange-500 px-3 py-1 rounded text-xs font-bold uppercase tracking-widest border border-orange-600/20">COD</span>
                                </div>
                                <p class="text-white font-black text-2xl mb-2 uppercase italic"><?php echo htmlspecialchars($productName); ?></p>
                        ...
                        <div class="bg-orange-600/10 border border-orange-600/20 p-4 rounded-lg mb-8">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-300 text-sm leading-relaxed">Our team will contact you shortly to confirm your delivery details. You'll pay cash when you receive your order.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="index.html" class="w-full bg-orange-600 text-white py-4 rounded-md font-black text-lg hover:bg-orange-500 transition-all uppercase tracking-tighter text-center custom-shadow">
                                Back to Home
                            </a>
                            <a href="index.html#products" class="w-full bg-transparent border border-slate-700 text-white py-4 rounded-md font-bold hover:bg-slate-800 transition-all uppercase tracking-widest text-center">
                                Continue Shopping
                            </a>
                        </div>
                    </div>
